...
function getListView() {
    dtview = $("#table-list").DataTable({
        ...
        columnDefs: [
            ...
            {
                mRender: function (data, type, row) {
                    var $rowData = `<button type="button" class="btn btn-primary btn-icon-sm permissiondet-btn"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-fill-lock" viewBox="0 0 16 16">
                                        <path d="M11 5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm-9 8c0 1 1 1 1 1h5v-1a1.9 1.9 0 0 1 .01-.2 4.49 4.49 0 0 1 1.534-3.693C9.077 9.038 8.564 9 8 9c-5 0-6 3-6 4Zm7 0a1 1 0 0 1 1-1v-1a2 2 0 1 1 4 0v1a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1h-4a1 1 0 0 1-1-1v-2Zm3-3a1 1 0 0 0-1 1v1h2v-1a1 1 0 0 0-1-1Z"/>
                                    </svg></button>`;
                    $rowData += `<button type="button" class="btn btn-info btn-icon-sm edit-btn mx-2"><i class="fa fa-pencil"></i></button>`;
                      ...
                      <div class="card-body"> 
                        <div class="course-widget"> 
                          ...
                          <div> 
                            ...
                            }</h6><span class="f-light f-12">Nama Role</span>
                            <div class="d-flex">
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <button class="btn btn-info btn-sm text-center" type="button" onclick='editRole(${item.id
                            },this)'><i class="fa fa-pencil"></i></button>
                                    <button class="btn btn-danger btn-sm text-center" type="button" onclick='deleteRole(${item.id
                    ...
                    <div class="card course-box"> 
                      <div class="card-body"> 
                        <div class="course-widget"> 
                          ...
                          <div> 
                            <h6 class="mb-0">Add</h6><span class="f-light f-12">Nama Role</span>
                            <div class="d-flex">
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <button class="btn btn-info btn-sm text-center" type="button" onclick='addRole()'><i class="fa fa-plus"></i></button>
                                </div>
                            </div>
                          </div>
                        </div>
