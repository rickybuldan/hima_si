...
class Transaction extends Model
{
    ...
    protected $fillable = ['no_transaction','transaction_start_date','transaction_end_date','transaction_type','status','created_by','price_total','customer_name','phone','email','address','description','bukti'];
