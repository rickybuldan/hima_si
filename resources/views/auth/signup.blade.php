...
@section('content')
    <div class="row">
        <div class="col-xl-5">
            <img class="bg-img-cover bg-center" src="{{ asset('template/admin2/assets/images/login/4.png') }}"
                alt="looginpage">
        </div>
                    ...
                    <div class="login-main">
                        <div class="theme-form">
                            ...
                            <div class="form-group mb-0">
                                ...
                                <button class="btn btn-primary btn-block w-100" id="save-btn">Daftar</button>
                            </div>
                        </div>
